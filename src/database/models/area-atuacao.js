...
// Nome da Área de Atuação: Tipo de dado - Lista de Texto(ENUM), Obrigatório: Sim, Armazena o nome das "Áreas de Atuação" presentes na plataforma (por exemplo: Tecnologia, Negócios, Soft Skills).
// Descrição da Área de Atuação: Tipo de dado - Texto (String), Obrigatório: Não, Breve descrição sobre a Área de Atuação.
// Foto da Área de Atuação: Tipo de dado - Imagem (URL da imagem ou arquivo), Obrigatório: Não, Uma imagem que faça referência a da Área de Atuação para tornar mais explicativo.
